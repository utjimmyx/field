---
title: "Sample Talks - Reproducible Interactive Dashboard Design Using R and R Markdown - ACME 2022 Workshop"
format: html
...
Below is a summary of the workshop presentation I delivered at the ACME marketing conference in 2022.

# Get Started

## Please find the interactive dashboard you will be trying to build below
...
You can see an introduction to Flexdashboard here [its homepage](https://pkgs.rstudio.com/flexdashboard/). You should read the information and try it on your own at least once to know how to
